...
function NavBar() {
    ...
    return <nav className="nav-bar">
        ...
        {user ? <span className="container-buttons">Welcome Back {user.username}! <button onClick={logOut}>Log Out</button></span> : 
        (<span className="container-buttons"><Link to="/sign-up"><button className="signUpButton">Sign Up</button></Link> 
